...
sims <- bugs(data=data, inits=inits, parameters.to.save = c("alpha", "beta4", "beta5", "beta6", "tau"), model.file = model, n.chains=1, n.iter=10000, n.burnin = 5000)
...
sims <- bugs(data=data, inits=inits, parameters.to.save = c("alpha", "beta5", "beta6", "tau"), model.file = model, n.chains=1, n.iter=10000, n.burnin = 5000)
...
```{r, echo=TRUE}
best <- brm(data=cars, mpg ~ horsepower + model.year + origin)
summary(best)
plot(best)
prior_summary(best)
```